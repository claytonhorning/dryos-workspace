...
/**
 * GitHub's own mark, at whatever size the box gives it.
 *
 * Drawn here rather than twice: the nav links to the repo and the clone block
 * on /mcp does too, and a second copy of a 300-character path is a second
 * thing to keep right.
 */
