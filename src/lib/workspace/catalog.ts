...
export const SCHEMAS: Schema[] = [
  ...
  // SPP's bus-level prices (`spp_bus_lmp.py`): the settlement-location files'
  // bus twins, 9,252 buses, untyped and unplaced. The real-time one is heavy.
  {
    id: "energy.spp.rtbus",
    path: ["Energy", "Pricing", "RT bus LMP"],
    name: "SPP real-time bus LMP",
    short: "RT · bus LMP",
    dataset: "spp-rt-lmp-bus",
    availability: "live",
    cadence: { label: "every 5 min", seconds: 300 },
    tokens: 1,
    entities: { count: 9_252, label: "buses", sample: ["CSWS112_WGORLD1", "CSWS121LYNN4LD1"] },
    blurb:
      "Real-time balancing market prices at every SPP electrical bus — about 9,250 of " +
      "them, the western market included — with the energy, congestion and loss " +
      "components, every five minutes.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "lmp_total", label: "Total LMP", unit: "$/MWh", availability: "live",
        description: "The five-minute real-time price at the bus.", mock: { base: 26, swing: 12, noise: 3 } },
      { key: "lmp_congestion", label: "Congestion", unit: "$/MWh", availability: "live",
        description: "Marginal congestion component.", mock: { base: 0, swing: 8, noise: 2 } },
      { key: "lmp_loss", label: "Losses", unit: "$/MWh", availability: "live",
        description: "Marginal loss component.", mock: { base: 0, swing: 1.5, noise: 0.4 } },
      { key: "lmp_energy", label: "Energy", unit: "$/MWh", availability: "live",
        description: "Marginal energy component, published by SPP.", mock: { base: 26, swing: 10, noise: 2 } },
    ],
  },
  {
    id: "energy.spp.dabus",
    path: ["Energy", "Pricing", "DA bus LMP"],
    name: "SPP day-ahead bus LMP",
    short: "DA · bus LMP",
    dataset: "spp-dam-lmp-bus",
    availability: "live",
    cadence: { label: "daily, afternoon CT", seconds: 86_400 },
    intervalSeconds: 3_600,
    tokens: 0.5,
    entities: { count: 9_252, label: "buses", sample: ["CSWS112_WGORLD1", "CSWS77_MEMLD1"] },
    blurb:
      "Hourly day-ahead prices at every SPP electrical bus, the western market " +
      "included, with the energy, congestion and loss components, posted for the " +
      "whole of tomorrow each afternoon.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "lmp_total", label: "Total LMP", unit: "$/MWh", availability: "live",
        description: "The hourly day-ahead price at the bus.", mock: { base: 24, swing: 14, noise: 2 } },
      { key: "lmp_congestion", label: "Congestion", unit: "$/MWh", availability: "live",
        description: "Marginal congestion component.", mock: { base: 0, swing: 8, noise: 2 } },
      { key: "lmp_loss", label: "Losses", unit: "$/MWh", availability: "live",
        description: "Marginal loss component.", mock: { base: 0, swing: 1.5, noise: 0.4 } },
      { key: "lmp_energy", label: "Energy", unit: "$/MWh", availability: "live",
        description: "Marginal energy component, published by SPP.", mock: { base: 24, swing: 10, noise: 2 } },
    ],
  },
  // SPP's daily reports (`spp_daily.py`): the two authorities as zones, except
  // hourly load, which is by control zone.
  {
    id: "energy.spp.curtailments",
    path: ["Energy", "Generation", "Curtailments"],
    name: "SPP wind and solar curtailments",
    short: "Curtailments",
    dataset: "spp-curtailments",
    availability: "live",
    cadence: { label: "daily, a day behind", seconds: 86_400 },
    intervalSeconds: 300,
    tokens: 0.25,
    entities: { count: 2, label: "balancing authorities", sample: ["SPP", "SWPW"] },
    entityKey: "zone",
    blurb:
      "Wind and solar curtailed every five minutes in SPP's RTO and RTO West — by " +
      "redispatch, manually by the operator, and for energy — a day behind.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "wind_redispatch_mw", label: "Wind · redispatch", unit: "MW", availability: "live",
        description: "Wind curtailed by redispatch.", mock: { base: 300, swing: 400, noise: 50, floor: 0 } },
      { key: "wind_manual_mw", label: "Wind · manual", unit: "MW", availability: "live",
        description: "Wind curtailed manually by the operator.", mock: { base: 50, swing: 100, noise: 20, floor: 0 } },
      { key: "wind_for_energy_mw", label: "Wind · for energy", unit: "MW", availability: "live",
        description: "Wind curtailed for energy.", mock: { base: 100, swing: 200, noise: 30, floor: 0 } },
      { key: "solar_redispatch_mw", label: "Solar · redispatch", unit: "MW", availability: "live",
        description: "Solar curtailed by redispatch.", mock: { base: 30, swing: 60, noise: 10, floor: 0 } },
      { key: "solar_manual_mw", label: "Solar · manual", unit: "MW", availability: "live",
        description: "Solar curtailed manually by the operator.", mock: { base: 5, swing: 10, noise: 3, floor: 0 } },
      { key: "solar_for_energy_mw", label: "Solar · for energy", unit: "MW", availability: "live",
        description: "Solar curtailed for energy.", mock: { base: 20, swing: 40, noise: 8, floor: 0 } },
    ],
  },
  {
    id: "energy.spp.rtsummary",
    path: ["Energy", "Grid", "Market summary"],
    name: "SPP real-time market summary",
    short: "RT · summary",
    dataset: "spp-rt-market-clearing",
    availability: "live",
    cadence: { label: "daily, a day behind", seconds: 86_400 },
    intervalSeconds: 300,
    tokens: 0.25,
    ...
    entityKey: "zone",
    blurb:
      "The real-time market's five-minute summary for the RTO and RTO West — " +
      "generation, demand response, interchange, the system marginal price and the " +
      "range of prices across the footprint — a day behind.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "smp", label: "System marginal price", unit: "$/MWh", availability: "live",
        description: "The system marginal price.", mock: { base: 26, swing: 12, noise: 3 } },
      { key: "min_lmp", label: "Min LMP", unit: "$/MWh", availability: "live",
        description: "The lowest LMP in the authority.", mock: { base: 5, swing: 10, noise: 3 } },
      { key: "max_lmp", label: "Max LMP", unit: "$/MWh", availability: "live",
        description: "The highest LMP in the authority.", mock: { base: 60, swing: 40, noise: 8 } },
      { key: "generation_mw", label: "Generation", unit: "MW", availability: "live",
        description: "Generation cleared.", mock: { base: 40_000, swing: 8_000, noise: 300 } },
      { key: "nsi_mw", label: "Net interchange", unit: "MW", availability: "live",
        description: "Net scheduled interchange, in SPP's sign.", mock: { base: 800, swing: 1_000, noise: 60 } },
    ],
  },
  {
    id: "energy.spp.dasummary",
    path: ["Energy", "Grid", "Market summary"],
    name: "SPP day-ahead market summary",
    short: "DA · summary",
    dataset: "spp-dam-market-clearing",
    availability: "live",
    cadence: { label: "daily, afternoon CT", seconds: 86_400 },
    intervalSeconds: 3_600,
    tokens: 0.25,
    ...
    entityKey: "zone",
    blurb:
      "The day-ahead market's hourly summary for the RTO and RTO West — generation, " +
      "demand and virtual bids cleared, interchange and the system marginal price — " +
      "posted for tomorrow each afternoon.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "smp", label: "System marginal price", unit: "$/MWh", availability: "live",
        description: "The system marginal price.", mock: { base: 24, swing: 14, noise: 2 } },
      { key: "total_demand_mw", label: "Total demand", unit: "MW", availability: "live",
        description: "Total demand cleared.", mock: { base: 40_000, swing: 8_000, noise: 300 } },
      { key: "generation_mw", label: "Generation", unit: "MW", availability: "live",
        description: "Generation cleared.", mock: { base: 38_000, swing: 8_000, noise: 300 } },
      { key: "cleared_virtual_bid_mw", label: "Virtual bids", unit: "MW", availability: "live",
        description: "Virtual bids cleared.", mock: { base: 5_000, swing: 2_000, noise: 200 } },
      { key: "cleared_virtual_offer_mw", label: "Virtual offers", unit: "MW", availability: "live",
        description: "Virtual offers cleared.", mock: { base: 10_000, swing: 3_000, noise: 300 } },
    ],
  },
  {
    id: "energy.spp.loadhourly",
    path: ["Energy", "Load", "Hourly actual by area"],
    name: "SPP hourly load by control zone",
    short: "Load · hourly",
    dataset: "spp-load-hourly",
    availability: "live",
    cadence: { label: "daily, two days behind", seconds: 86_400 },
    intervalSeconds: 3_600,
    tokens: 0.25,
    entities: { count: 20, label: "control zones", sample: ["CSWS", "OKGE", "WACM"] },
    entityKey: "zone",
    blurb:
      "Hourly load in each of SPP's 20 control zones across the RTO and RTO West, split " +
      "as SPP files it into CF and NC load, about two days behind.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "load_mw", label: "Load", unit: "MW", availability: "live",
        description: "The zone's load for the hour, CF and NC together.",
        mock: { base: 2_000, swing: 1_500, noise: 60 } },
      { key: "load_cf_mw", label: "CF load", unit: "MW", availability: "live",
        description: "Load filed under SPP's Forecast Area Type CF.",
        mock: { base: 1_900, swing: 1_500, noise: 60 } },
      { key: "load_nc_mw", label: "NC load", unit: "MW", availability: "live",
        description: "Load filed under SPP's Forecast Area Type NC; seven zones have it.",
        mock: { base: 150, swing: 100, noise: 10 } },
    ],
  },
  {
    id: "energy.spp.outages",
    path: ["Energy", "Grid", "Generation outages"],
    name: "SPP capacity on outage",
    short: "Outages",
    dataset: "spp-gen-outages",
    availability: "live",
    cadence: { label: "daily, a week ahead", seconds: 86_400 },
    intervalSeconds: 3_600,
    tokens: 0.25,
    entities: { count: 3, label: "balancing authorities", sample: ["SPP", "SWPW", "Total"] },
    entityKey: "zone",
    // Total is SPP and SWPW summed; stacked on them it counts twice.
    entityOmit: ["Total"],
    blurb:
      "Generating capacity forecast out of service, hour by hour a week ahead, by fuel, " +
      "for the RTO and RTO West — every daily report kept.",
    maintainer: { name: "Dryos", since: Date.UTC(2026, 8, 14) },
    variables: [
      { key: "outaged_mw", label: "Outaged", unit: "MW", availability: "live",
        description: "Capacity forecast out for the hour, every fuel.",
        mock: { base: 13_000, swing: 3_000, noise: 200 } },
      { key: "coal_mw", label: "Coal", unit: "MW", availability: "live",
        description: "Of which coal.", mock: { base: 4_000, swing: 1_000, noise: 50 } },
      { key: "natural_gas_mw", label: "Natural gas", unit: "MW", availability: "live",
        description: "Of which natural gas.", mock: { base: 5_500, swing: 1_500, noise: 80 } },
      { key: "wind_mw", label: "Wind", unit: "MW", availability: "live",
        description: "Of which wind.", mock: { base: 700, swing: 400, noise: 30 } },
      { key: "hydro_mw", label: "Hydro", unit: "MW", availability: "live",
        description: "Of which hydro.", mock: { base: 1_400, swing: 300, noise: 20 } },
    ],
  },
